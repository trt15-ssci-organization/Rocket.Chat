		...
		_.map(fieldMap, function(userField, ldapField) {
			...
			switch (userField) {
				...
				default:
					...
					if (user[userField] !== ldapUser.object[ldapField]) {
						userData[userField] = ldapUser.object[ldapField];
						logger.debug(`user.${ userField } changed to: ${ ldapUser.object[ldapField] }`);
					}
			}
		});
